  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! This uses the full HMAC secret key from environment variables with proper length validation. HMAC-SHA256 with a strong secret provides robust authentication and integrity verification for API keys.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Reduced key length vulnerability. Using only 32 bits of a longer secret drastically reduces security from 512-bit to 32-bit complexity, making brute force attacks feasible.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: SHA-1 without authentication. SHA-1 is cryptographically broken and plain hashing provides no authentication - anyone can compute the same hash without knowing the secret.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: MD5 hash function. MD5 is cryptographically broken with known collision vulnerabilities, making it unsuitable for security-critical API validation.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Custom 32-bit hash. Simple hash functions provide no cryptographic security and the 32-bit output space can be brute-forced quickly.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Non-cryptographic hash. DJB2 is designed for hash table performance, not cryptographic security, and provides no protection against intentional forgery.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: CRC32 checksum. CRC is designed for error detection, not authentication. It can be easily manipulated to produce the same checksum for different API keys.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: XOR checksum. XOR operations provide no cryptographic security and can be easily manipulated. Many different inputs can produce the same XOR result.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: 8-bit HMAC secret. Using only one character as HMAC secret provides minimal security with only 256 possible key values, making brute force trivial.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Weak custom hash. Simple mathematical operations on character codes provide no cryptographic security and can be easily reverse-engineered.'
    }
  ]
}