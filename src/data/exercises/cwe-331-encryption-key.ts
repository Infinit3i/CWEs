  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! PBKDF2 with 100,000 iterations and a cryptographically random 32-byte salt provides high entropy. The random salt ensures unique keys even for identical passwords, and the high iteration count makes brute force attacks computationally expensive.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Insufficient entropy from weak password + short salt. Using only 4 characters of salt and 10 iterations provides minimal entropy expansion, making keys vulnerable to brute force attacks.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Insufficient entropy from predictable timestamp. Timestamps provide minimal additional entropy and can be guessed within narrow ranges, especially combined with weak passwords.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Extremely low entropy from character sum. Reducing password to a 16-bit sum drastically reduces entropy, making keys easily brute-forceable with only 65,536 possibilities.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Insufficient salt length. A 3-character salt provides only about 15 bits of entropy (95^3 possibilities), insufficient for preventing rainbow table attacks on common passwords.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: No entropy expansion. Direct character mapping provides no additional entropy beyond the original password, making keys as weak as the input password.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Low entropy time components. Day of week and hour provide only log2(7*24) ≈ 8 bits of entropy, insufficient for strengthening encryption keys.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Process ID as low entropy source. Process IDs provide limited entropy (log2(1000) ≈ 10 bits) and can often be predicted or observed by attackers.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: String length as entropy source. Password and salt lengths provide minimal entropy (typically 1-4 bits) and reveal information about the original inputs.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: System state as low entropy. Memory usage provides limited entropy and can be influenced or observed by attackers, making it unsuitable as a primary entropy source.'
    }
  ]
}