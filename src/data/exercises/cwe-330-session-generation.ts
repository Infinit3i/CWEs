  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! crypto.randomBytes() uses the operating system's cryptographically secure random number generator (CSPRNG) which provides unpredictable values suitable for security-critical applications like session IDs.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: User ID as PRNG seed. Because the seed is always the user ID, the session ID will always be the same for each user, enabling session prediction and hijacking.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Timestamp as seed. Using current time as seed creates predictable patterns since timestamps are sequential and can be guessed within reasonable ranges.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Statistical PRNG for security purposes. Math.random() is designed for statistical applications, not cryptographic security. It produces predictable sequences unsuitable for session IDs.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Linear Congruential Generator. Even with multiple seed sources, LCGs are not cryptographically secure and produce predictable sequences that can be analyzed.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Deterministic generation. Creating session IDs with predictable patterns based on user ID makes session hijacking trivial through pattern recognition.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Counter-based generation. Sequential or counter-based session IDs are highly predictable and allow attackers to easily guess valid session identifiers.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Hash of predictable inputs. While MD5 is deterministic, using predictable inputs (user ID + timestamp) makes the output guessable and MD5 has known vulnerabilities.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Fibonacci sequence generation. Mathematical sequences like Fibonacci are deterministic and predictable, making them unsuitable for security-critical random values.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: User ID derived sequence. Generating session IDs based on user ID creates predictable patterns that allow attackers to compute session IDs for any user.'
    }
  ]
}