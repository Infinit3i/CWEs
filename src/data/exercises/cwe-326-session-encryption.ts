  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! This uses AES-256-GCM with a proper secret key, random IV, and authenticated encryption. The session ID is used as additional input to the key derivation, and the system requires a strong master key from environment variables.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: 32-bit key vulnerable to brute force. With only 2^32 possible keys, this can be brute-forced in reasonable time with modern computing resources.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: ROT cipher (one-to-one mapping). Rotation ciphers can be easily broken through frequency analysis or by trying all 26 possible rotations.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: 8-bit key encryption. A single byte key provides only 256 possible values, making brute force trivial.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Reversible algorithm. String reversal combined with predictable character shifting provides no cryptographic security.'
    },
    {
    ...
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Simple substitution cipher. Character-by-character substitution is vulnerable to frequency analysis and pattern recognition.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Weak stream cipher. Starting with a single byte and incrementing creates a predictable keystream that can be analyzed.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: DES encryption. DES has insufficient key strength (56 bits) and can be brute-forced with dedicated hardware or cloud computing.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: 16-bit key vulnerable to brute force. With only 65,536 possible keys, this can be exhaustively searched very quickly.'
    }
  ]
}