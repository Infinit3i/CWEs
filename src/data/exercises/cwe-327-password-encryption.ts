  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! bcrypt is specifically designed for password hashing with adaptive cost. It's a one-way function that makes rainbow table attacks infeasible and allows adjusting computational cost as hardware improves.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: DES encryption. DES is considered insufficient for modern applications with only 56-bit effective key strength, making it vulnerable to brute force attacks.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: DES with CBC mode. While CBC is better than ECB, DES itself remains cryptographically weak regardless of the mode of operation.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: XOR obfuscation. XOR with a short key provides no cryptographic security and can be easily broken through known plaintext attacks.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Simple substitution cipher. Character-by-character substitution can be broken through frequency analysis and provides no real security.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: ROT cipher. Rotation ciphers are easily broken through frequency analysis or by trying all 26 possible rotation values.'
    },
    {
    ...
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Reversible transformation. String reversal with salt appending provides no cryptographic security and is trivially reversed.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Vigenère cipher. Classical polyalphabetic substitution ciphers can be broken through frequency analysis and Kasiski examination.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: SHA-1 hash function. SHA-1 is cryptographically broken (practical collision attacks since 2017) and is too fast for password hashing.'
    }
  ]
}