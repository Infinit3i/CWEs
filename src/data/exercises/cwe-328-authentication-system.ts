...
export const cwe328AuthenticationSystem: Exercise = {
  ...
  options: [
    ...
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'SHA-1 without salt. SHA-1 is cryptographically weak (broken in 2017) and without salt, passwords are vulnerable to rainbow table attacks and collision attacks.'
    },
    {
    ...
    },
    {
      ...
      correct: false,
      explanation: 'Custom weak hash. Simple hash functions like this provide no cryptographic security and can be easily reverse-engineered or brute-forced.'
    },
    {
      ...
      correct: false,
      explanation: 'CRC32 checksum. CRC is designed for error detection, not cryptographic security. It provides no collision resistance and can be easily manipulated.'
    },
    {
      ...
      correct: false,
      explanation: 'SHA-1 with predictable salt. While adding username as salt is better than no salt, SHA-1 is still broken and username is predictable, reducing security.'
    },
    {
      ...
      correct: false,
      explanation: 'XOR checksum. XOR operations provide no cryptographic security and can be easily manipulated. Many different passwords can produce the same XOR result.'
    },
    {
      ...
      correct: false,
      explanation: 'Simple checksum. Addition-based checksums provide no cryptographic security and many different passwords will produce the same sum.'
    },
    {
      ...
      correct: false,
      explanation: 'Adler-32 checksum. Like other checksums, Adler-32 is designed for error detection and provides no cryptographic security against intentional attacks.'
    },
    {
      ...
      correct: false,
      explanation: 'ROT13 obfuscation with weak hash. ROT13 provides no security improvement, and SHA-1 remains cryptographically broken regardless of input transformation.'
    }
  ]
}