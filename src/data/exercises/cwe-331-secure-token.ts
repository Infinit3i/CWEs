  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! crypto.randomBytes(32) provides 256 bits of cryptographic entropy from a secure source. This ensures security tokens are unpredictable and cannot be forged or guessed by attackers.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Insufficient entropy from predictable sources. User ID, session type (4 options), and current second (60 options) provide very limited total entropy, making tokens guessable.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Timestamp as primary entropy. Using timestamp modulo provides limited entropy (~27 bits) and creates predictable patterns in token generation.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Character code sum entropy. Summing character codes of known strings provides minimal entropy and makes tokens predictable for known user IDs.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Process ID and user ID entropy. PIDs and UIDs can be observed or predicted, and millisecond timestamps provide limited additional entropy.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Calendar-based entropy. Day of week, hour, and user modulo provide limited entropy (~17 bits total) and are highly predictable.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Character multiplication entropy. Multiplying character codes creates overflow and modulo operations that reduce entropy to a limited range.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: System resource entropy. Memory usage and CPU time provide limited entropy (~27 bits) and can be influenced or observed by attackers.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: ASCII sum multiplication. Computing products of character sums provides limited entropy space (24 bits) and is deterministic for known inputs.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: String length and character code entropy. User ID length and first character of session type provide minimal entropy, making tokens predictable.'
    }
  ]
}