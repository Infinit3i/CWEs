  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! AES-256-GCM provides strong encryption with authenticated encryption. PBKDF2 strengthens the shared secret, and GCM mode ensures both confidentiality and integrity of the message.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: TEA (Tiny Encryption Algorithm) in ECB mode. TEA has known cryptanalytic weaknesses and the ECB mode reveals patterns in data, making it unsuitable for secure communications.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: DES algorithm. DES is cryptographically insufficient with only 56-bit effective key strength, making it vulnerable to brute force attacks with modern hardware.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: XOR with single-byte key. This provides no cryptographic security as the key can be easily recovered through known plaintext or frequency analysis.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: ROT cipher obfuscation. Rotation ciphers provide no cryptographic security and can be easily broken through frequency analysis or brute force.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Multi-byte XOR cipher. While better than single-byte XOR, this is still vulnerable to known plaintext attacks and frequency analysis.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: MD5-based stream cipher. MD5 is cryptographically broken, and using hash digits as XOR keys provides weak encryption vulnerable to analysis.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Classical cipher (Playfair variant). Historical ciphers like Playfair can be broken through frequency analysis and pattern recognition techniques.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: PRNG-based encryption. Linear congruential generators are not cryptographically secure and produce predictable output sequences.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Book cipher variant. This provides only obfuscation rather than encryption and can be easily reverse-engineered once the method is understood.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: RC4 stream cipher. RC4 has known vulnerabilities and biases in its keystream, making it unsuitable for secure communications (deprecated in TLS).'
    }
  ]
}