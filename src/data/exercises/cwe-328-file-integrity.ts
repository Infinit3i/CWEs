  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! SHA-256 provides strong collision resistance and is recommended by NIST for integrity verification. It's computationally infeasible for attackers to create files with the same SHA-256 hash, ensuring reliable integrity checking.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: MD5 hash function. MD5 has known collision vulnerabilities - attackers can create malicious files with the same MD5 hash as legitimate files, breaking integrity verification.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: SHA-1 weak hash. SHA-1 is cryptographically broken with practical collision attacks demonstrated, making it unsuitable for file integrity verification.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Custom weak hash. Simple bit shifting and XOR operations provide no cryptographic security and can be easily manipulated to produce collisions.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: CRC32 checksum. CRC is designed for error detection, not cryptographic integrity. It can be easily manipulated to produce the same checksum for different file contents.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Simple checksum. Addition-based checksums provide no cryptographic security and many different files can produce the same checksum value.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: XOR checksum. XOR operations provide no cryptographic security and can be trivially manipulated. Many different files can produce the same XOR result.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Adler-32 checksum. Like other checksums, Adler-32 is designed for error detection and provides no protection against intentional file modification.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Non-cryptographic hash. DJB2 is optimized for hash table performance, not cryptographic security, and provides no collision resistance.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Non-cryptographic hash. FNV-1a is designed for hash table applications and provides no cryptographic security for integrity verification.'
    }
  ]
}