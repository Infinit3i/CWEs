  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! HMAC-SHA256 with a secret key provides both data integrity and authentication. This prevents attackers from forging fingerprints even if they know the input data, making session hijacking much more difficult.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: SHA-1 without authentication. SHA-1 is cryptographically broken and without a secret key, attackers can compute the same fingerprint if they know the user agent, IP, and session ID.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: MD5 hash function. MD5 is cryptographically broken with known collision vulnerabilities and provides no authentication without a secret key.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Non-cryptographic hash. DJB2 is designed for hash table performance, not cryptographic security, and provides no protection against fingerprint forgery.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: CRC32 checksum. CRC is designed for error detection, not cryptographic security, and can be easily manipulated to produce the same fingerprint.'
    },
    {
    ...
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Simple checksum. Addition-based checksums provide no cryptographic security and many different fingerprint combinations can produce the same sum.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Adler-32 checksum. Like other checksums, Adler-32 is designed for error detection and provides no protection against intentional fingerprint manipulation.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: ROT13 obfuscation with weak hash. ROT13 provides no cryptographic value, and SHA-1 remains broken regardless of input transformation.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Non-cryptographic hash. FNV-1a is optimized for hash table applications and provides no cryptographic security for session fingerprinting.'
    }
  ]
}