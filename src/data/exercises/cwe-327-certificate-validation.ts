  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! SHA-256 with RSA-PSS provides strong cryptographic security. SHA-256 is collision-resistant, and PSS padding provides better security properties than PKCS#1 v1.5 padding against various attacks.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: MD5 hash algorithm. MD5 has known collision vulnerabilities that allow attackers to create different certificates with the same signature, breaking certificate integrity.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: SHA-1 hash algorithm. SHA-1 is cryptographically broken with practical collision attacks demonstrated in 2017, making it unsuitable for certificate signing.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Custom weak hash. Simple checksum algorithms provide no collision resistance and can be easily manipulated to produce the same hash for different certificate data.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: CRC32 checksum. CRC is designed for error detection, not cryptographic hashing. It can be easily manipulated to produce collisions for certificate forgery.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: HMAC-MD5. While HMAC provides authentication, the underlying MD5 hash function is broken, and using a fixed key defeats the purpose of certificate signing.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: ROT13 obfuscation with broken hash. ROT13 provides no cryptographic value, and SHA-1 is broken, making this combination unsuitable for certificate security.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Adler-32 checksum. Like other checksums, Adler-32 provides no cryptographic security and can be easily manipulated for certificate forgery.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Non-cryptographic hash. DJB2 is designed for hash table performance, not cryptographic security, and provides no collision resistance for certificate integrity.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: XOR checksum. XOR provides no cryptographic security and can be trivially manipulated to produce the same result for different certificate data.'
    }
  ]
}