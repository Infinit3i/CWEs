  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! SHA-256 is a cryptographically secure hash function that provides strong collision resistance. It's recommended by NIST and security communities for integrity verification, replacing the broken SHA-1 algorithm.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: SHA-1 is theoretically broken since 2005 and practically broken since 2017. Collision attacks make it unsuitable for integrity verification in security-critical applications.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: MD5 has known collision vulnerabilities. Attackers can create malicious firmware with the same MD5 hash as legitimate firmware.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Custom hash function. Simple checksum algorithms provide no cryptographic security and can be easily manipulated to produce collisions.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: CRC32 is designed for error detection, not cryptographic security. It can be easily manipulated to produce the same checksum for different data.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Simple checksum. Addition-based checksums provide no cryptographic security and can be trivially forged.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: XOR checksum. XOR operations provide no cryptographic security and can be easily manipulated by attackers.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Adler-32 checksum. Like other checksums, Adler-32 is designed for error detection and provides no cryptographic security against intentional tampering.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Custom rotation-based hash. Simple rotation and XOR operations do not provide cryptographic security and can be easily reverse-engineered.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Non-cryptographic hash function. DJB2 is designed for hash table performance, not cryptographic security, and provides no collision resistance.'
    }
  ]
}