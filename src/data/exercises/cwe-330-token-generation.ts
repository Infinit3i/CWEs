  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! crypto.randomBytes() provides cryptographically secure random values that are unpredictable. This ensures authentication tokens cannot be guessed or forged by attackers, maintaining secure API access control.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Predictable seeding with user/app IDs. The token will be the same for each user-application combination, allowing attackers to predict tokens for any user.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Timestamp seeding. Using current time as seed makes tokens predictable within time windows, allowing attackers to guess tokens generated around the same time.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Statistical PRNG for security purposes. Math.random() is designed for statistical applications, not cryptographic security, producing predictable sequences unsuitable for authentication tokens.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Deterministic token generation. Creating tokens with predictable patterns based on user/app IDs makes token forgery trivial through pattern recognition.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Sequential token generation. Using predictable sequences based on IDs and timestamps allows attackers to systematically generate valid tokens.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Hash of predictable inputs. While SHA-1 is deterministic, using predictable inputs (IDs + timestamp) makes tokens guessable, and SHA-1 has known vulnerabilities.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Non-cryptographic PRNG with predictable seed. Mersenne Twister is not cryptographically secure and using user/app IDs as seeds makes tokens predictable.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: XorShift PRNG with predictable inputs. XorShift is fast but not cryptographically secure, and using predictable inputs makes token generation vulnerable to analysis.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Linear Feedback Shift Register. LFSRs are deterministic and not cryptographically secure, making tokens predictable once the internal state is determined.'
    }
  ]
}