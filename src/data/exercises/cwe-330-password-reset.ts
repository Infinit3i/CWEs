  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! crypto.randomBytes() provides cryptographically secure random values that are unpredictable. This ensures password reset codes cannot be guessed by attackers, maintaining account security.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Predictable seeding with email hash + user ID. Since email and user ID are known or guessable, attackers can compute the same reset codes, compromising password reset security.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Direct timestamp usage. Using timestamp directly makes reset codes highly predictable within narrow time windows, enabling account takeover attacks.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Statistical PRNG for security purposes. Math.random() produces predictable sequences unsuitable for password reset codes that protect account access.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Sequential generation based on predictable inputs. Using timestamp and user ID creates predictable patterns that allow systematic code guessing.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Deterministic calculation from known values. Email length and user ID digits are observable or guessable, making reset codes predictable.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Hash of predictable inputs with time rounding. Using minute-level timestamps with known email/user ID makes codes guessable within minute windows.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Prime-based seeding with LCG. Using known primes with user ID creates predictable seeds, and LCGs are not cryptographically secure.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Calendar-based generation. Day of year and hour are predictable time components that create systematic patterns allowing code prediction.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: System state with predictable components. Memory usage may vary but combined with timestamp and user ID creates patterns that can be estimated or observed.'
    }
  ]
}