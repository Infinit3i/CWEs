  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! crypto.randomBytes(32) provides 256 bits of cryptographic entropy for salt generation. This ensures each password has a unique, unpredictable salt that prevents rainbow table attacks and makes password cracking much more difficult.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Username hash plus time. Using username as primary entropy means identical usernames get similar salts, and hourly time granularity provides minimal additional entropy.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Direct timestamp usage. Timestamps provide minimal entropy and create predictable patterns - users registering around the same time get similar salts.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: String length and character entropy. Username length and first character provide very limited entropy (typically < 10 bits), making salts highly predictable.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Calendar-based entropy. Day of year provides only ~9 bits of entropy and creates patterns where all users registering on the same day get identical salts.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Character code sum. Summing character codes provides very limited entropy and many different usernames can produce the same sum, leading to salt collisions.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Deterministic transformation. Reversing the username and hashing provides no additional entropy beyond the username itself, and limits output to 16 bits.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Linguistic pattern entropy. Vowel and consonant counts provide very limited entropy and many usernames will have similar character distributions.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Process ID entropy. Process IDs provide limited entropy and can be observed or predicted, especially in containerized environments where PIDs are often sequential.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: System memory entropy. Memory usage provides limited entropy (16 bits with modulo) and can be influenced by attackers or observed through system monitoring.'
    }
  ]
}