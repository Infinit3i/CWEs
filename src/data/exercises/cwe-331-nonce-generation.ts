  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! crypto.randomBytes(16) provides 128 bits of cryptographic entropy for nonce generation. This ensures nonces are unpredictable and unique, preventing replay attacks and maintaining cryptographic security protocols.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Insufficient entropy from predictable IDs. Transaction and client IDs are known values, and millisecond timing provides minimal entropy (~20 bits total), making nonces predictable.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Timestamp modulo entropy. Using timestamp % 10000000 provides limited entropy (~23 bits) and creates predictable cycles in nonce generation within time windows.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Sequential nonce generation. Adding known transaction and client IDs creates predictable sequences that allow nonce prediction and potential replay attacks.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Deterministic hash of known inputs. MD5 hash of known transaction and client IDs provides zero entropy - the same inputs always produce the same nonce.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Calendar-based entropy. Day of week and hour provide only ~8 bits of entropy, and combined with known transaction IDs, create highly predictable nonces.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Character code sum entropy. Summing character codes of known strings provides minimal entropy and many different ID combinations can produce the same sum.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Mathematical sequence entropy. Fibonacci numbers are deterministic and provide entropy only based on index selection from known inputs.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Process statistics entropy. Process ID and uptime can be observed or predicted, providing limited entropy that varies slowly over time.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: System state percentage. Memory usage percentage provides very limited entropy (~7 bits) and can be influenced by attackers or observed through monitoring.'
    }
  ]
}