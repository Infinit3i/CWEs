  ...
  options: [
    {
      ...
      correct: true,
      explanation: `Correct! crypto.randomBytes() provides cryptographically secure random values that are unpredictable. This prevents attackers from guessing receipt URLs and accessing other customers' order information.`
    },
    // Real MITRE demonstrative examples as wrong answers
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Timestamp seeding of PRNG. Using current time as seed creates predictable receipt URLs since timestamps are sequential and can be guessed within reasonable timeframes.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Statistical PRNG for security-sensitive identifiers. Math.random() produces predictable outputs unsuitable for creating secure URLs that protect customer privacy.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Direct timestamp usage. Using timestamp directly makes receipt URLs highly predictable - attackers can easily guess URLs generated around the same time period.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Predictable combination. Combining order total with timestamp creates predictable patterns that allow attackers to systematically guess receipt URLs.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Sequential identifiers. Using incrementing counters makes receipt URLs trivially predictable - attackers can access all receipts by iterating through numbers.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Process ID with timestamp. Process IDs and timestamps are both predictable values that can be enumerated, making receipt URL guessing feasible.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Hash of predictable inputs. While MD5 is deterministic, using predictable inputs (timestamp + order total) makes the output guessable within reasonable ranges.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: Mathematical sequence based on time. Fibonacci-like sequences initialized with timestamps are predictable and can be computed by attackers.'
    },
    {
      ...
      correct: false,
      explanation: 'MITRE pattern: System state with timestamp. Memory usage and timestamps are both observable or predictable system states that can be estimated by attackers for URL guessing.'
    }
  ]
}